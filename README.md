...
# Fork & Tribute
[github@zmxv](https://github.com/zmxv/bitmexgo)

## Overview
This go-bitmex package enables golang clients to call [REST APIs](https://www.bitmex.com/app/restAPI) for the Bitmex crypto trading platform.
